...
bg_img = pygame.image.load('image/sk1.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('image/dirt.png')
grass_img = pygame.image.load('image/grass.png')
blob_img = pygame.image.load('image/blob.png')
platform_x_img = pygame.image.load('image/platform_x.png')
platform_y_img = pygame.image.load('image/platform_y.png')
...
save_img = pygame.image.load('image/save_btn.png')
load_img = pygame.image.load('image/load_btn.png')
